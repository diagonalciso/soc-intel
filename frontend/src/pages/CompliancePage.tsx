...
const get80053Controls    = (family: string | null, q: string, includeEnhancements: boolean) =>
  api.get('/compliance/800-53/controls', { params: { family: family || undefined, q: q || undefined, include_enhancements: includeEnhancements || undefined, size: 1500 } }).then(r => r.data)
...
function Controls80053Panel() {
  ...
  const { data: controlsData, isLoading: controlsLoading } = useQuery({
    queryKey: ['800-53-controls', selectedFamily, q, showEnhancements],
    queryFn: () => get80053Controls(selectedFamily, q, showEnhancements),
  })
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 16px' }}>
        <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 12 }}>
          ...
          <label style={{
            ...
            color: showEnhancements ? 'var(--accent)' : 'var(--text-secondary)',
