...
from app.connectors.builtin.shinyhunters import ShinyHuntersConnector
from app.connectors.builtin.cti_news_feed import CTINewsFeedConnector
from app.connectors.builtin.telegram_cti import TelegramCTIConnector
...
from app.connectors.builtin.blocklist_de import BlocklistDeConnector
from app.connectors.builtin.c2_tracker import C2TrackerConnector
from app.connectors.builtin.ipsum import IPsumConnector
...
CONNECTORS = [
    ...
    LeakSiteScraper(),
    ShinyHuntersConnector(),
    CTINewsFeedConnector(),
    TelegramCTIConnector(),
    URLhausConnector(),
    ThreatFoxConnector(),
